...
# You'll also learn how to use Regular Expressions by building your own password generator
# program.
...
def generate_password(length=16, nums=1, special_chars=1, uppercase=1, lowercase=1):
    ...
    while True:
        ...
        constraints = [(nums, r"\d"), (special_chars, rf"[{symbols}]"), (uppercase, r"[A-Z]"), (lowercase, r"[a-z]")]
