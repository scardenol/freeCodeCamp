...
# Add 'overweight' column. To determine if a person is overweight, first calculate their
# BMI by dividing their weight in kilograms by the square of their height in meters. If
# that value is > 25 then the person is overweight. Use the value 0 for NOT overweight and
...
def draw_heat_map():
    ...
    # Draw the heatmap with 'sns.heatmap()'. lower font size to fit labels
    sns.heatmap(
        corr,
        mask=mask,
        annot=True,
